...
class Variable(PolymorphicModel, Described):
    ...
    def get_chart_record(self, data_viz: DataViz, geog: CensusGeography,
                         time_part: TimeAxis.TimePart,) -> Dict[str, any]:
        """
        ...
        return {
            'variable': self.name,
            'time_series': time_part.slug,
            'geog': geog.common_geoid,
            'value': value
        }
